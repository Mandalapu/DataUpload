...
//		if(obj.has("d101"))d101=obj.getString("d101");
//		else d101=null;
//		if(obj.has("d102"))d102=obj.getString("d102");
//		else d102=null;
...
//		if(obj.has("d142_start"))d142_start=obj.getString("d142_start");
//		else d142_start="0000-00-00 00:00:00";
//		if(obj.has("d143_start"))d143_start=obj.getString("d143_start");
//		else d143_start="0000-00-00 00:00:00";
//		if(obj.has("d144_start"))d144_start=obj.getString("d144_start");
//		else d144_start="0000-00-00 00:00:00";
//		if(obj.has("d145_start"))d145_start=obj.getString("d145_start");
//		else d145_start="0000-00-00 00:00:00";
//		if(obj.has("d146_start"))d146_start=obj.getString("d146_start");
//		else d146_start="0000-00-00 00:00:00";
		if(obj.has("d148_start"))d148_start=obj.getString("d148_start");
		else d148_start="0000-00-00 00:00:00";
//		if(obj.has("d178_start"))d178_start=obj.getString("d178_start");
//		else d178_start="0000-00-00 00:00:00";
//		if(obj.has("d179_start"))d179_start=obj.getString("d179_start");
//		else d179_start="0000-00-00 00:00:00";
//		if(obj.has("d180_start"))d180_start=obj.getString("d180_start");
//		else d180_start="0000-00-00 00:00:00";
...
//		if(obj.has("d142_end"))d142_end=obj.getString("d142_end");
//		else d142_end="0000-00-00 00:00:00";
//		if(obj.has("d143_end"))d143_end=obj.getString("d143_end");
//		else d143_end="0000-00-00 00:00:00";
//		if(obj.has("d144_end"))d144_end=obj.getString("d144_end");
//		else d144_end="0000-00-00 00:00:00";
//		if(obj.has("d145_end"))d145_end=obj.getString("d145_end");
//		else d145_end="0000-00-00 00:00:00";
//		if(obj.has("d146_end"))d146_end=obj.getString("d146_end");
//		else d146_end="0000-00-00 00:00:00";
		if(obj.has("d148_end"))d148_end=obj.getString("d148_end");
		else d148_end="0000-00-00 00:00:00";
//		if(obj.has("d178_end"))d178_end=obj.getString("d178_end");
//		else d178_end="0000-00-00 00:00:00";
//		if(obj.has("d179_end"))d179_end=obj.getString("d179_end");
//		else d179_end="0000-00-00 00:00:00";
//		if(obj.has("d180_end"))d180_end=obj.getString("d180_end");
//		else d180_end="0000-00-00 00:00:00";

//		if(obj.has("d142"))d142=obj.getInt("d142");
//		else d142=-1;
//		if(obj.has("d143"))d143=obj.getInt("d143");
//		else d143=-1;
//		if(obj.has("d144"))d144=obj.getInt("d144");
//		else d144=-1;
//		if(obj.has("d145"))d145=obj.getInt("d145");
//		else d145=-1;
//		if(obj.has("d146"))d146=obj.getInt("d146");
//		else d146=-1;
//		if(obj.has("d178"))d178=obj.getInt("d178");
//		else d178=-1;
//		if(obj.has("d179"))d179=obj.getInt("d179");
//		else d179=-1;
//		if(obj.has("d180"))d180=obj.getInt("d180");
//		else d180=-1;
...
//		rfstart2=obj.getString("rf201_start");
//		rfstart3=obj.getString("rf301_start");
		rfend1=obj.getString("rf101_end");
//		rfend2=obj.getString("rf201_end");
...
//		an4=obj.getInt(qn4+"_ans");an5=obj.getInt(qn5+"_ans");an6=obj.getInt(qn6+"_ans");
	...
	public static void tasktrack() throws JSONException {
		...
		//String seca_s=obj.getString("general_info_start");
		//String seca_e=obj.getString("general_info_end");
		...
		//String secpv_s=obj.getString("sec_pv_start");
		//String secpv_e=obj.getString("sec_pv_end");
		//String secve_s=obj.getString("sec_ve_start");
		//String secve_e=obj.getString("sec_ve_end");
		...
		//String secsw_s=obj.getString("sec_sw_start");
		//String secsw_e="";
		//if(obj.has("sec_sw_end"))secsw_e=obj.getString("sec_sw_end");
		//else secsw_e=obj.getString("swset3_end");
